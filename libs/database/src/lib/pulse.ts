...
import { List1, List2, List3 } from '../../../eiwiz-handler/src/lib/types';
import { Status } from '../../../common/src/lib/status';
...
export const _List1Data = sequelize.define('List1', {
  powImpActive: {
    type: DataTypes.FLOAT,
    allowNull: false
  },
...
export const _List2Data = sequelize.define('List2', {
  date: {
    type: DataTypes.DATE,
    allowNull: false
  },
...
export const _List3Data = sequelize.define<Model<Omit<List3, 'type'>>>('List3',
  {
    date: {
      type: DataTypes.DATE,
      allowNull: false
...
/*
export const AggregatedData = sequelize.define('AggregatedData', {
  cumulativePower: {
    type: DataTypes.FLOAT,
    allowNull: false
  }
...
export const _PulseStatus = sequelize.define<Model<Status>>('PulseStatus', {
  rssi: {
    type: DataTypes.INTEGER,
  },
  ch: {
